...
public class FSMOnSendMessage : StateMachineBehaviour
{
	...
	override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		{
			EventManager.Instance.PostNotification(EventManager.EVENT_TYPE.FSM_UPDATE, animator.transform.parent, signal);
		}
	...
	override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		{
			EventManager.Instance.PostNotification(EventManager.EVENT_TYPE.FSM_EXIT, animator.transform.parent, signal);
		}
